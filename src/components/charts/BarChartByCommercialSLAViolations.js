...
import {fetchCommercialSlaViolationsData, selectCommercialSlaViolationsReportData} from "../../redux/combined/commercialSLAViolationsReport";
...
const BarChartByCommercialSLAViolations = () => {
    ...
    const data = useSelector(selectCommercialSlaViolationsReportData);
    useEffect(() => {
        dispatch(fetchCommercialSlaViolationsData());
...
export default BarChartByCommercialSLAViolations;
