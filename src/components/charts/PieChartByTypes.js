...
import {selectDateFrom, selectDateTo, selectSelectedPriorities, selectSelectedProjects, selectSelectedStates} from "../../redux/combined/reportFilters";
import {fetchTypesReportData, selectTypesReportData} from "../../redux/combined/typesReport";
...
const PieChartByTypes = () => {
    ...
    const data = useSelector(selectTypesReportData);
    useEffect(() => {
        dispatch(fetchTypesReportData());
    }, [projects, selectedProjects, selectedPriorities, selectedStates, dateFrom, dateTo]);
...
export default PieChartByTypes;
