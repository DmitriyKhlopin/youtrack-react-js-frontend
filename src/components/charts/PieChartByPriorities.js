...
import {fetchPrioritiesReportData, selectPrioritiesReportData} from "../../redux/combined/prioritiesReport";
...
const PieChartByPriorities = () => {
    ...
    const data = useSelector(selectPrioritiesReportData);
    useEffect(() => {
        dispatch(fetchPrioritiesReportData());
...
export default PieChartByPriorities;
